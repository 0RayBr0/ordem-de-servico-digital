...
function retorna($quero_buscar, $conexaoSQL)
{
  ...
  $comando_query = "SELECT 
    ...
    status_do_chamado,
    observacao
   FROM table2_osc WHERE numero_chamado = $quero_buscar LIMIT 1;";
  ...
  if($resultado_query->num_rows)
  {
    ...
    else $valores['checkbox_SAI'] = false;
    ...
    $valores['data_de_abertura'] = $row_informacoes['data_abertura_osc'];
    $valores['hora_de_abertura'] = $row_informacoes['hora_abertura_osc'];
    $valores['data_de_fechamento'] = $row_informacoes['data_fechamento_osc'];
    $valores['hora_de_fechamento'] = $row_informacoes['hora_fechamento_osc'];
    //$valores['calculo'] = $row_informacoes['calculo_tempo_atendimento'];

    $valores['causas_identificadas'] = $row_informacoes['causas_identificadas'];
    $valores['efeito'] = $row_informacoes['efeito'];
    $valores['acao_realizada'] = $row_informacoes['acao_realizada'];
    $valores['cartao_de_material'] = $row_informacoes['cartao_material'];
    $valores['qtd'] = $row_informacoes['qtd'];

    $valores['radio_STATUS_CHAMADO'] = $row_informacoes['status_do_chamado'];

    $valores['observacao'] = $row_informacoes['observacao'];
  ...
  else
  {
    ...
    $valores['mantenedores'] = 'não encontrado';
    $valores['solicitantes'] = 'não encontrado';
    $valores['res_area'] = 'não encontrado';
    $valores['res_contrato'] = 'não encontrado';
    $valores['data_emissao'] = 'não encontrado';
    $valores['local'] = 'não encontrado';
    $valores['centro_custo'] = 'não encontrado';
    ...
    $valores['data_de_abertura'] = '';
    $valores['hora_de_abertura'] = '';
    $valores['data_de_fechamento'] = '';
    $valores['hora_de_fechamento'] = '';

    $valores['causas_identificadas'] = '';
    $valores['efeito'] =  '';
    $valores['acao_realizada'] =  '';
    $valores['cartao_de_material'] = '';
    $valores['qtd'] = '';
    $valores['radio_STATUS_CHAMADO'] = '';
    $valores['observacao'] = '';
  }
  return json_encode($valores);
}
if(isset($_GET['numero_chamado'])){
  echo retorna($_GET['numero_chamado'], $conn);
}
